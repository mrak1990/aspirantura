...
$this->widget('ext.ChosenAjaxAddition.ChosenAjaxAddition',
    array(
        'target' => $selector,
...
$this->widget('application.widget.inlineDropdownCreate.chosenInlineCreate',
    array(
        'jsPrefix' => $jsPrefix,
        'url' => 'staff/create',
...
$data = $model->dean !== null
    ? CHtml::listData(array($model->dean), 'id', 'fio')
    : array();
echo $form->dropDownListRow($model, 'staff_id', $data,
    array(
        'class' => 'span5',
        'maxlength' => 20,
        'hint' => $hint,
